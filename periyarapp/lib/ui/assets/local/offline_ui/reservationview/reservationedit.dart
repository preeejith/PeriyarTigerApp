...
class ReservationEdit extends StatefulWidget {
  ...
  @override
  State<ReservationEdit> createState() => _ReservationEditState();
}

class _ReservationEditState extends State<ReservationEdit> {
  ...
  void fetcher() async {
    referredbycontroller.text = widget.state.items7![widget.index]['refered'];
    print(referredbycontroller.toString());
    guestnamecontroller.text = widget.state.items7![widget.index]['guestName'];
    noofpersonaccompanyingcontroller.text =
        widget.state.items7![widget.index]['NoofCompaningPerson'];
    ...
    refpersonphonecontroller.text =
        widget.state.items7![widget.index]['referedPhone'];
    emailcontroller.text = widget.state.items7![widget.index]['email'];
    ...
    detailscontroller.text = widget.state.items7![widget.index]['details'];
    noofroomsrequiredcontroller.text =
        widget.state.items7![widget.index]['reservedcount'];
    datecontroller.text = widget.state.items7![widget.index]['bookingdate'];
    dropdownvalue =
        widget.state.items7![widget.index]['foodprefered'] == "Non Vegitarian"
            ? "Non-Vegetarian"
            : widget.state.items7![widget.index]['foodprefered'] == "Vegitarian"
                ? "Vegetarian"
