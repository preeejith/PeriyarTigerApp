...
class EditMarkAttendance extends StatefulWidget {
  const EditMarkAttendance({Key? key}) : super(key: key);

  @override
  _EditMarkAttendance createState() => _EditMarkAttendance();
}

class _EditMarkAttendance extends State<EditMarkAttendance> {
  String? token;
  ...
  void fetcher() async {
    ...
    // BlocProvider.of<EditMarkAttendanceOfflineBloc>(context)
    //     .add(GetEditMarkAttendanceData());
                                                              ...
                                                              : Container(
                                                                  ...
                                                                  child: IconButton(
                                                                    onPressed:
                                                                      ...
                                                                      setState(
                                                                          () {
                                                                        markattantencelist[index].startok =
                                                                            true;
                                                                        markattantencelist[index].markpresentfalse ==
                                                                                true
                                                                            ? markattantencelist[index].markpresentfalse =
                                                                                false
                                                                            : markattantencelist[index].markpresentfalse =
                                                                        ...
                                                                        markattantencelist[index].markpresentfalse ==
                                                                                true
                                                                            ? markattantencelist[index].markpresenttrue =
                                                                                false
                                                                            : markattantencelist[index].markpresenttrue =
                                                                                true;
                                                                        ...
                                                                        markattantencelist[index].markpresentfalse ==
                                                                                true
                                                                            ? markattantencelist[index].change =
                                                                                false
                                                                            : markattantencelist[index].change =
                                                                                true;
                                                                      });
                                                                    ...
                                                                    child: IconButton(
                                                                      onPressed:
                                                                        ...
                                                                        setState(
                                                                          ...
                                                                          markattantencelist[index].startok =
                                                                              true;
                                                                          markattantencelist[index].markpresenttrue == true
                                                                              ? markattantencelist[index].markpresenttrue = false
                                                                              : markattantencelist[index].markpresenttrue = true;

                                                                          markattantencelist[index].markpresenttrue == true
                                                                              ? markattantencelist[index].markpresentfalse = false
                                                                              : markattantencelist[index].markpresentfalse = true;

                                                                          markattantencelist[index].markpresenttrue == true
                                                                              ? markattantencelist[index].change = true
                                                                              : markattantencelist[index].change = false;
                                                                        });
                                                                      },
                                                                      color: Colors
                                                                          .green,
                                                                ...
                                                                : Row(
                                                                    children: [
                                                                      MaterialButton(
                                                                          ...
                                                                          height:
                                                                              20,
                                                                          color: markattantencelist[index].leave == false
                                                                              ? Colors.grey
                                                                              : Colors.green,
                                                                          onPressed: () {
                                                                            specialDay == true
                                                                                ? Fluttertoast.showToast(backgroundColor: Colors.white, msg: "can't change", textColor: Colors.black)
                                                                                :
                                                                      ...
                                                                      MaterialButton(
                                                                          ...
                                                                          height:
                                                                              20,
                                                                          color: markattantencelist[index].absent == false
                                                                              ? Colors.grey
                                                                              : Colors.green,
                                                                          onPressed: () {
                                                                            // datealready ==
                                                                            ...
                                                                            setState(() {
                                                                              markattantencelist[index].absent == true ? markattantencelist[index].absent = false : markattantencelist[index].absent = true;

                                                                              markattantencelist[index].absent == true ? markattantencelist[index].leave = false : markattantencelist[index].leave = true;
                                                                            });
                                                                          })
                                                                    ],
                                                                  ),
                                                                                  ...
                                                                                  MaterialButton(
                                                                                      ...
                                                                                      onPressed: () async {
                                                                                        leavereasoncontroller.text.isEmpty
                                                                                            ...
                                                                                            : setState(() {
                                                                                                markattantencelist[index].leavereason = leavereasoncontroller.text.toString();
...
////////////////////////////////////////////////////////
                      ...
                      if (markattantencelist[i].empid ==
                        ...
                        if (state.items9![j]['isPresent'] == '1') {
                          ...
                          setState(() {
                            ...
                            markattantencelist[i].leavereason =
                                state.items9![j]['reason'];
  ...
  void validate() {
    for (int i = 0; i < markattantencelist.length; i++) {
      ...
      final isPresent = markattantencelist[i].change == true ? 1 : 0;
      final isPresent2 = markattantencelist[i].change == true ? true : false;
      ...
      final reason = markattantencelist[i].leavereason;
      final edited = "true";
      if (empid!.isEmpty) {
        return;
      } else {
        ...
        // markAttendance(data);
/////
        getmarkattendancedata(isPresent, leaveType, reason, edited, empid);
        getupdatepresentdata(isPresent2, empid);
////for adding to local list start
        ...
        // };
        // print(data2);
        getattendancedetailsdata(isPresent, leaveType,reason, empid);
