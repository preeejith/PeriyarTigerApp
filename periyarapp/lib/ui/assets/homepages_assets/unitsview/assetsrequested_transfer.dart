...
class AssetsTransferRequested extends StatefulWidget {
  final String requestId;
  final String assetId;

  const AssetsTransferRequested(
      {Key? key, required this.requestId, required this.assetId})
      : super(key: key);

  @override
  State<AssetsTransferRequested> createState() =>
      _AssetsTransferRequestedState();
}

class _AssetsTransferRequestedState extends State<AssetsTransferRequested> {
  String? token;
                              ...
                              return
                                ...
                                child: Column(children: [
                                  InkWell(
                                    ...
                                    onTap: () {
                                      setState(() {
                                        productidcontroller.text = state
                                            .viewAllAssetsModel
                                            .data[index]
                                            .assetId
                                            .id;
                                                  ...
                                                  MaterialButton(
                                                    ...
                                                    onPressed: () {
                                                      if (quantitycontroller
                                                        ...
                                                        BlocProvider.of<GetTransferRequestBloc>(context).add(
                                                            GetTransferRequest(
                                                                requestId: widget
                                                                    .requestId,
                                                                assetId: widget
