...
class EntryDataDownloadPage extends StatefulWidget {
  const EntryDataDownloadPage({Key? key}) : super(key: key);

  @override
  State<EntryDataDownloadPage> createState() => _EntryDataDownloadPageState();
}

class _EntryDataDownloadPageState extends State<EntryDataDownloadPage> {
  @override
  void dispose() {
    DownloadBloc().close();
    super.dispose();
                ...
                builder: ((context, state) {
                  if (state is SlotDataAddedState) {
                    return ListTile(
                      ...
                      title: Text("Bookings data downloaded"),
                    );
                  }
                  return ListTile(
                    leading: SizedBox(
                    ...
                    title: Text("Bookings vehicle data"),
                  );
                })),
            BlocBuilder<DownloadBloc, DownloadState>(
                buildWhen: ((previous, current) =>
