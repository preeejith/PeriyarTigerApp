class ReservationEditModel {
  ...
  ReservationEditModel.fromJson(dynamic json) {
    status = json['status'];
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    status = json['status'];
    foodPreference = json['foodPreference'] != null ? json['foodPreference'].cast<String>() : [];
    vehicleNumbers = json['vehicleNumbers'] != null ? json['vehicleNumbers'].cast<String>() : [];
    id = json['_id'];
