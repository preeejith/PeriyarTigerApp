...
//   ViewUnitsRequestModel.fromJson(Map<String, dynamic> json) {
//     status = json['status'];
//     msg = json['msg'];
...
//     id = json['_id'];
//     empId = json['empId'];
//     // unitId =json['unitId']==null?: UnitId.fromJson(json['unitId'])  ;
...
//     _data['_id'] = id;
//     _data['empId'] = empId;
//     _data['unitId'] = unitId.toJson().toString();
//     _data['typeOfRequest'] = typeOfRequest;
...
//   UnitId.fromJson(Map<String, String> json) {
//     // location = List.castFrom<String, String>(json['location']);
//     status = json['status'].toString();
//     // unitincharge = List.castFrom<String, String>(json['unitincharge'].toString());
...
//     // V = json['__v'];
//     unitUnderIc = json['unitUnderIc'].toString();
//   }
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    requestStatus = json['requestStatus']==null?"":json['requestStatus'];
    id = json['_id'];
    empId = json['empId'];
    //  unitId = UnitId.fromJson(json['unitId']);
   unitId = UnitId.fromJson(json['unitId']==null?"":json['unitId']);
